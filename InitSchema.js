...
async function createMemberTable(conn)
{
    ...
    await conn.query("create table member (id varchar(20), password char(64), " + 
...
async function createBoardTable(conn)
{
    ...
    await conn.query("create table board (board_id int auto_increment, board_class int, " + 
...
async function createKWEBDB()
{
    ...
    try
    {
        ...
        await conn.query("create database kweb");
